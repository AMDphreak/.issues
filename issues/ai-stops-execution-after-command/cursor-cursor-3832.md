---
title: AI stops execution after shell command completion instead of continuing automatically
repository: cursor/cursor
issue_number: 3832
url: https://github.com/cursor/cursor/issues/3832
...
5. User must manually cancel the command output (resulting in `q^C` in the terminal) to prompt the AI to continue
   ...
   <img width="705" height="241" alt="Image" src="https://github.com/user-attachments/assets/c424e931-bf7f-4f2b-9862-dd76d4e621bc" />
