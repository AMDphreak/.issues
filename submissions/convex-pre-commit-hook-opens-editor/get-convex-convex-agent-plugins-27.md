---
title: Windows: beforeShellExecution hook opens pre-commit-checks.sh in editor on git commit
repository: get-convex/convex-agent-plugins
issue_number: 27
url: https://github.com/get-convex/convex-agent-plugins/issues/27
