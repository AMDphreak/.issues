---
title: 'Flux Nunchaku: GPU OOM for 1 GB Tensor Allocation & Missing CPU Fallback'
repository: Acly/krita-ai-diffusion
issue_number: 2390
url: https://github.com/Acly/krita-ai-diffusion/issues/2390
...
![OOM Error Screenshot](https://raw.githubusercontent.com/AMDphreak/.issues/main/issues/krita-ai-diffusion-tensor-oom/screenshots/oom_error.png)
...
Add `cpu_offload="auto"` and other parameters to the `NunchakuFluxDiTLoader` call in `comfy_workflow.py`.

Fixed in: <https://github.com/Acly/krita-ai-diffusion/pull/2391>
