...
- <https://github.com/asciidoctor/asciidoctor-vscode/issues/> (tabs rendering): `[tabs]` is rendered as a single block with sections stacked vertically instead of interactive tabs; that different rendering can also affect sync (source line vs. preview block mapping).
